...
If you want to check out an html test, I have [a page](notes/html-test) you can try out that
includes all of the basic html components I render on a regular basis.