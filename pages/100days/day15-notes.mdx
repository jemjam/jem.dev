...
export const frontMatter = {
    ...
    desc:
        'Here are my notes from the day, unedited',
    date: '2020-09-01',
    day: 15,
}
...
Tiger Oakes [Diane Ko (she/her)](https://app.slack.com/team/UB850BWMC)
[11:03 AM](https://cascadiajs.slack.com/archives/C016GNFPD6K/p1598983386399700)
...
**Saving Data to the DWeb: A Primer and a Practical Perspective** content is
chunked, max size 256kb chunk labels are hash of the content
...
[Kelsey Breseman](https://app.slack.com/team/UBD1UE1GD)
[2:22 PM](https://cascadiajs.slack.com/archives/C016GNFPD6K/p1598995357272500)
...
Break / Twilio etc
**[Kelsey Breseman [she/her]](https://app.slack.com/team/UBD1UE1GD)**
[2:28 PM](https://cascadiajs.slack.com/archives/C0XRSNJC8/p1598995714370400) I
don’t think I’ve ever seen a conf pass the Bechdel test with such flying colors,
so great
...
really useful for sharing your own blog posts and stuff if you want short things
to point to if someone asks you about something you've done!
